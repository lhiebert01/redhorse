  ...
  return (
    <main className="min-h-screen bg-fire-gradient relative overflow-hidden">
          ...
          >
            ...
            <div className="flex flex-col lg:flex-row">
              ...
              <div className="lg:w-1/2 p-4 lg:p-6 flex flex-col">
                ...
                <button
                  onClick={() => setShowPrivacyInfo(true)}
                  className="w-full flex items-center justify-center gap-2 bg-green-900/20 border border-green-700/50 rounded-xl p-3 mb-4 hover:border-green-500 transition-colors"
                >
                  <span className="bg-green-600 text-white w-5 h-5 rounded-full flex items-center justify-center text-xs font-bold">i</span>
                  <span className="text-green-400 font-bold text-sm">Illustrative Example</span>
                  <span className="text-gray-400 text-xs">- Your Oracle has no names/DOB</span>
                  <span>🛡️</span>
                </button>
      ...
      {showPrivacyInfo && (
        ...
        >
          <div
            className="bg-black border-2 border-green-600 rounded-2xl max-w-lg w-full p-6 relative"
            onClick={(e) => e.stopPropagation()}
          >
            {/* Close Button */}
            <button
              onClick={() => setShowPrivacyInfo(false)}
              className="absolute top-3 right-3 bg-green-600 hover:bg-green-500 text-white font-bold w-8 h-8 rounded-full flex items-center justify-center transition-all"
            >
              ✕
            </button>
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h3 className="text-xl font-bold text-green-400">Privacy by Design</h3>
                <p className="text-gray-400 text-sm">About These Examples</p>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="bg-green-900/20 border border-green-700/50 rounded-xl p-4">
                <p className="text-white font-bold mb-2">Why do these examples show names and dates?</p>
              ...
              <div className="bg-red-900/20 border border-red-700/50 rounded-xl p-4">
                <p className="text-fire-gold font-bold mb-2">Your Real Oracle is Different</p>
                <p className="text-gray-300 text-sm leading-relaxed">
              ...
              <div className="bg-black/50 border border-gray-700 rounded-xl p-4">
                <p className="text-white font-bold mb-2">What IS on Your Oracle?</p>
